...
from app.settings.config import settings  # Добавили импорт нашего конфига
from app.db.database import Base  # Добавили импорт нашей мета-БД
from app.models import User  # Добавили импорт модели, чтобы она инициализировалась, но она не используется
